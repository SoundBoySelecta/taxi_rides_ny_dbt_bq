...
7. Once the tables are detected within BQ per your translation project_id.dataset.table =  databae.schema.table, you can auto generate the associated model and save
    - Note in demo the autogenerated models created an extra staging folder under the existing staging forlder, I think this is because the instructions were wrong in video.
